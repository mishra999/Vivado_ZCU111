...
#endif*/
// {1441856, 2148795168, 2148795169, 2148795170,
//3222536227, 1075052580, 2148802053, 53477382, 19922951, 100728840,
//1431655753, 2432844042, 67178507, 453771372, 587368557, 33554446,
//2147516431, 3243574288, 88, 46777369, 2410151962, 268443163,
//2170908, 25166653, 33555262, 4128799}
...
printf("\n Configuring the Clock \r\n");
	...
	for (Tile = 0; Tile <4; Tile++) {
		for (Block = 0; Block <4; Block++) { // channel=block=slice
